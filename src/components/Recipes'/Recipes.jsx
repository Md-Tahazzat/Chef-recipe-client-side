  ...
  return (
    <div>
      <section className="my-10 ">
        <div className="card border md:card-side mt-10 w-full md:w-4/6 mx-auto bg-slate-100 shadow-xl">
          <figure
            className="md:w-3/6 rounded
        "
          >
            <img className="w-6/6 h-72 rounded-lg" src={img} alt="chef" />
          </figure>
          <div className="card-body text-slate-600 md:w-3/6">
